...
interface ReplacePaginationProps {
  currentPage: number;
  totalPages: number;
  itemsPerPage: number;
  totalItems: number;
...
export const ReplacePagination = ({
  currentPage,
  totalPages,
  itemsPerPage,
  totalItems,
...
}: ReplacePaginationProps) => {
  return (
    <div className="flex items-center justify-between flex-wrap gap-3 px-4 py-4 border-t border-[#07484A]/20">
